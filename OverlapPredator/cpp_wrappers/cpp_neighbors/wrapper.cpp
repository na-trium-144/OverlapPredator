...
static PyObject* batch_neighbors(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	if ((int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(queries_array)) != 2 || (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(queries_array), 1) != 3)
	{
		Py_XDECREF(queries_array);
		Py_XDECREF(supports_array);
		Py_XDECREF(q_batches_array);
	...
	if ((int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(supports_array)) != 2 || (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(supports_array), 1) != 3)
	{
		Py_XDECREF(queries_array);
		Py_XDECREF(supports_array);
		Py_XDECREF(q_batches_array);
	...
	if ((int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(q_batches_array)) > 1)
	{
		Py_XDECREF(queries_array);
		Py_XDECREF(supports_array);
		Py_XDECREF(q_batches_array);
	...
	if ((int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(s_batches_array)) > 1)
	{
		Py_XDECREF(queries_array);
		Py_XDECREF(supports_array);
		Py_XDECREF(q_batches_array);
	...
	if ((int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(q_batches_array), 0) != (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(s_batches_array), 0))
	{
		Py_XDECREF(queries_array);
		Py_XDECREF(supports_array);
		Py_XDECREF(q_batches_array);
	...
	// Number of points
	int Nq = (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(queries_array), 0);
	int Ns= (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(supports_array), 0);

	// Number of batches
	int Nb = (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(q_batches_array), 0);
	...
	queries = vector<PointXYZ>((PointXYZ*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(queries_array)), (PointXYZ*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(queries_array)) + Nq);
	supports = vector<PointXYZ>((PointXYZ*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(supports_array)), (PointXYZ*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(supports_array)) + Ns);
	q_batches = vector<int>((int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(q_batches_array)), (int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(q_batches_array)) + Nb);
	s_batches = vector<int>((int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(s_batches_array)), (int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(s_batches_array)) + Nb);
	...
	memcpy(PyArray_DATA(reinterpret_cast<PyArrayObject*>(res_obj)), neighbors_indices.data(), size_in_bytes);

...
static PyObject* batch_subsampling(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	if ((int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(points_array)) != 2 || (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(points_array), 1) != 3)
	{
		Py_XDECREF(points_array);
		Py_XDECREF(batches_array);
		Py_XDECREF(classes_array);
	...
	if ((int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(reinterpret_cast<PyArrayObject*>(batches_array))) > 1)
	{
		Py_XDECREF(points_array);
		Py_XDECREF(batches_array);
		Py_XDECREF(classes_array);
	...
	if (use_feature && ((int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(features_array)) != 2))
	{
		Py_XDECREF(points_array);
		Py_XDECREF(batches_array);
		Py_XDECREF(classes_array);
	...
	if (use_classes && (int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(classes_array)) > 2)
	{
		Py_XDECREF(points_array);
		Py_XDECREF(batches_array);
		Py_XDECREF(classes_array);
	...
	// Number of points
	int N = (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(reinterpret_cast<PyArrayObject*>(points_array)), 0);

	// Number of batches
	int Nb = (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(batches_array), 0);

	// Dimension of the features
	int fdim = 0;
	if (use_feature)
		fdim = (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(features_array), 1);

	//Dimension of labels
	int ldim = 1;
	if (use_classes && (int)PyArray_NDIM(reinterpret_cast<PyArrayObject*>(classes_array)) == 2)
		ldim = (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(classes_array), 1);

	// Check that the input array respect the number of points
	if (use_feature && (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(features_array), 0) != N)
	{
		Py_XDECREF(points_array);
		Py_XDECREF(batches_array);
		Py_XDECREF(classes_array);
	...
	if (use_classes && (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(classes_array), 0) != N)
	{
		Py_XDECREF(points_array);
		Py_XDECREF(batches_array);
		Py_XDECREF(classes_array);
	...
	original_points = vector<PointXYZ>((PointXYZ*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(points_array)), (PointXYZ*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(points_array)) + N);
	original_batches = vector<int>((int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(batches_array)), (int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(batches_array)) + Nb);
	if (use_feature)
		original_features = vector<float>((float*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(features_array)), (float*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(features_array)) + N * fdim);
	if (use_classes)
		original_classes = vector<int>((int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(classes_array)), (int*)PyArray_DATA(reinterpret_cast<PyArrayObject*>(classes_array)) + N * ldim);
	...
	memcpy(PyArray_DATA(reinterpret_cast<PyArrayObject*>(res_points_obj)), subsampled_points.data(), size_in_bytes);
	size_in_bytes = Nb * sizeof(int);
	memcpy(PyArray_DATA(reinterpret_cast<PyArrayObject*>(res_batches_obj)), subsampled_batches.data(), size_in_bytes);
	if (use_feature)
	{
		size_in_bytes = subsampled_points.size() * fdim * sizeof(float);
		res_features_obj = PyArray_SimpleNew(2, feature_dims, NPY_FLOAT);
		memcpy(PyArray_DATA(reinterpret_cast<PyArrayObject*>(res_features_obj)), subsampled_features.data(), size_in_bytes);
	}
	if (use_classes)
	{
		size_in_bytes = subsampled_points.size() * ldim * sizeof(int);
		res_classes_obj = PyArray_SimpleNew(2, classes_dims, NPY_INT);
		memcpy(PyArray_DATA(reinterpret_cast<PyArrayObject*>(res_classes_obj)), subsampled_classes.data(), size_in_bytes);
	}
...
static PyObject* cloud_subsampling(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	// Number of points
	int N = (int)PyArray_DIM(reinterpret_cast<PyArrayObject*>(points_array), 0);
